export default function Ieeecalltoaction() {
    return (
      <div>
        <section className="bg-white dark:bg-gray-900">
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <a href="#" className="inline-flex items-center dark:text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm text-center dark:focus:ring-primary-900">
                Get started
