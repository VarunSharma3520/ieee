export default function Ieeecardbottombar() {
  return (
    <div>
      <div
        style={{
        ...
        class="relative w-full max-w-sm overflow-y-auto bg-white border  border-gray-100 rounded-lg dark:bg-gray-700 dark:border-gray-600 h-96">
        <ul>
